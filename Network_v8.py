...
profilepath = 'saves/TensorBoard'
# figurepath = 'saves/ModelFigures'
modelsavepath = 'saves/Models/'
finalmodel = 'saves/Models/modelfinal.pkl'
internaltestpath = 'saves/internaltest.csv'
